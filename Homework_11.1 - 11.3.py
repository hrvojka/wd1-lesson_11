...
for score_dict in score_list[0:3]:
    print(f' NAME: {str(score_dict["name"])}, ATTEMPTS: {str(score_dict["attempts"])}, SECRET NUMBER: {str(score_dict["secret"])}, WRONG GUESSES: {str(score_dict["wrong_guesses"])}, DATE: {score_dict["date"]}')
